...
<body class="main">
	<section>
		<div class="center-block text-center">
        	<div>
            	<div style="color:#4F68FF;" class="padding-20">
                	<img src="Images/user-Icon1.png" style="width:150px;" />
        		</div>
                <div class="col-lg-3">  </div>
                <div class="col-lg-6 margin-top-30" id="main">
                	<form action="LandingPage.php" method="post" role="form">
               ...
               <div class="col-lg-3"> </div>
               <div class="col-lg-12 padding-20 font-size-20"> 
               		<a href="#" class="margin-right"> Home </a> <a href="#" class="margin-right"> Contact Us </a> <a href="#"> Support </a>
               </div> 
            </div>
        </div>		
	</section>
